...
size_t ZSTD_CCtx_setPledgedSrcSize(ZSTD_CCtx* cctx, u64 pledgedSrcSize)
{
...
static ZSTD_compressionParameters ZSTD_getCParams_internal(int compressionLevel, u64 srcSizeHint, size_t dictSize, ZSTD_CParamMode_e mode);
static ZSTD_parameters ZSTD_getParams_internal(int compressionLevel, u64 srcSizeHint, size_t dictSize, ZSTD_CParamMode_e mode);
...
static size_t ZSTD_estimateCCtxSize_internal(int compressionLevel)
{
    ...
    static const u64 srcSizeTiers[4] = {16 KB, 128 KB, 256 KB, ZSTD_CONTENTSIZE_UNKNOWN};
    for (; tier < 4; ++tier) {
...
size_t ZSTD_initCStream_srcSize(ZSTD_CStream* zcs, int compressionLevel, u64 pss)
{
    /* temporary : 0 interpreted as "unknown" during transition period.
     * Users willing to specify "unknown" **must** use ZSTD_CONTENTSIZE_UNKNOWN.
     * 0 will be interpreted as "empty" in the future.
...
ZSTD_compressionParameters ZSTD_getCParams(int compressionLevel, u64 srcSizeHint, size_t dictSize)
{
...
ZSTD_getParams_internal(int compressionLevel, u64 srcSizeHint, size_t dictSize, ZSTD_CParamMode_e mode)
{
    ZSTD_parameters params;
 ...
 * @return a `ZSTD_parameters` structure (instead of `ZSTD_compressionParameters`).
 *  Fields of `ZSTD_frameParameters` are set to default values */
ZSTD_parameters ZSTD_getParams(int compressionLevel, u64 srcSizeHint, size_t dictSize)
{
    if (srcSizeHint == 0) srcSizeHint = ZSTD_CONTENTSIZE_UNKNOWN;
